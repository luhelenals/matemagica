...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(gWindow))
    {
        ...
        case TRIRECTANGLES:
            ...
            //DrawShape(vbo, vao, shader, miniR0, GL_LINE_LOOP, 4);
            //DrawShape(vbo, vao, shader, miniR1, GL_LINE_LOOP, 4);
            //DrawShape(vbo, vao, shader, miniR2, GL_LINE_LOOP, 4);
            //DrawShape(vbo, vao, shader, miniR3, GL_LINE_LOOP, 4);
            //DrawShape(vbo, vao, shader, miniR4, GL_LINE_LOOP, 4);
